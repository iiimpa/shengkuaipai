        ...
        <el-table
            ...
            <el-table-column label="图片">
                <template slot-scope="scope">
                    <img :src="scope.row.image" width="200px;">
                </template>
            </el-table-column>
            ...
            <el-form :model="addForm">
                ...
                <el-form-item label="图片" label-width="120">
                    <el-upload
                        ...
                        <img v-if="addForm.image" :src="addForm.image" style="width: 100%;" class="avatar">
...
<script>
    export default {
        ...
        methods: {
            ...
            getData() {
                this.yy.query("/admin/friend/list").then(resp => this.list = resp.data);
            },
            addData() {
                this.yy.query("/admin/friend/add", {
            ...
            deleteData(id) {
                this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                    ...
                    this.yy.query("/admin/friend/delete", {id}).then(() => {
