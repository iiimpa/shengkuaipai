...
def mbaidu(keyword, domain, proxy, ua, resolution, delay):
    ...
    try:
        ...
        # 定位到text的文本框
        text = myweb.find_element_by_id("index-kw")
        ...
        # 定位到搜索键
        button = myweb.find_element_by_id("index-bn")
        # 点击搜索键
        button.click()
        ...
        while page < 10 and not finded:
            ...
            if not finded:
                ...
                next = myweb.find_elements_by_xpath("//*[@id=\"page\"]/a")
