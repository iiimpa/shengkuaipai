...
def sogou(keyword, domain, proxy, ua, resolution, delay):
    ...
    try:
        ...
        # 定位到text的文本框
        text = myweb.find_element_by_id("query")

        # 搜索词条
        text.send_keys(keyword)

        # 定位到搜索键
        button = myweb.find_element_by_id("stb")
        # 点击搜索键
        button.click()
        ...
        while page < 10 and not finded:
            ...
            if not finded:
                ...
                next = myweb.find_element_by_id("sogou_next")
